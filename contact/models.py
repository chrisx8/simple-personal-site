...
class ContactConfig(SingletonModel):
    ...
    notification_recipient = models.EmailField(
        blank=True,
    ...
    pgp_fingerprint = models.CharField(
        max_length=50, blank=True, verbose_name="Public key fingerprint"
    )
